...
class PlayState extends MusicBeatState {
	...
	override public function create() {
			...
			case 'hallowhalloween':
				{
					...
					mechanic = new FlxSprite(1240, 300);
					mechanic.frames = Paths.getSparrowAtlas('mechanicShit/paintingShit');
					mechanic.animation.addByPrefix('idle', 'paintingShit');
		...
		if(SONG.song.toLowerCase() == 'hallow' || SONG.song.toLowerCase() == 'calamity'){
			add(mechanic);
		}
		...
		if (SONG.song.toLowerCase() == 'crucify'
			...
			|| SONG.song.toLowerCase() == 'calamity'
	...
	private function generateSong(dataPath:String):Void {
		...
		for (section in noteData) {
			...
			if (daSection == 8 && curSong.toLowerCase() == 'calamity') SONG.noteStyle = 'paintingNotes';
	...
	override function stepHit() {
		...
		if (curStep == 384 && curSong == 'Party-Crasher') {
			...
			ShadersHandler.setChrome(FlxG.random.int(6, 6) / 1000);
	...
	override function beatHit() {
		...
		if (!boyfriend.animation.curAnim.name.startsWith("sing") && boyfriend.animation.curAnim.name != 'hey' || boyfriend.animation.curAnim.name == 'hey' && boyfriend.animation.curAnim.name != 'dodge' || boyfriend.animation.curAnim.name == 'dodge' && boyfriend.animation.finished) {
			boyfriend.playAnim('idle');
		}
