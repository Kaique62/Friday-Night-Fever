...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf-8bit':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('characters/tea-8bit');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'yukichi-8bit':
				// DAD ANIMATION LOADING CODE
				frames = Paths.getSparrowAtlas('characters/yukichi-8bit', 'shared');
				...
				addOffset("singRIGHT", -74, -7);
				addOffset("singLEFT", 72, 7);
				addOffset("singDOWN", -189, -62);
			...
			case 'pico':
				...
				{
					// fuc you ninja muffin!!!! why dont u flip it!!!
					animation.addByPrefix('singLEFT', 'Pico NOTE LEFT0', 24, false);
					animation.addByPrefix('singRIGHT', 'Pico Note Right0', 24, false);
			...
			case 'bf-casualdemon':
				...
				flipX = true;
			case 'bf-8bit':
				var tex = Paths.getSparrowAtlas('characters/cesar-8bit', 'shared');
				frames = tex;
