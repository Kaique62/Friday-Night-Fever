...
class HalloweenState extends MusicBeatState
{
	var songs:Array<MetaSongdata> = [];
	...
	override function create()
	{
		...
		var initSonglist = CoolUtil.coolTextFile(Paths.txt('halloweenfreeplaySonglist'));

		for (i in 0...initSonglist.length)
		{
			var data:Array<String> = initSonglist[i].split(':');
			songs.push(new MetaSongdata(data[0], Std.parseInt(data[2]), data[1]));
		}
		...
		PlayState.isHalloweenFreeplay = true;
	...
	{
		songs.push(new MetaSongdata(songName, weekNum, songCharacter));
	}
	...
	function changeDiff(change:Int = 0)
	{
		...
		if (songs[curSelected].songName == 'Hallow' || songs[curSelected].songName == 'Hardships' || songs[curSelected].songName == 'Prayer' || songs[curSelected].songName == 'Bad-Nun' || songs[curSelected].songName == 'Portrait' || songs[curSelected].songName == 'Space-Demons' || songs[curSelected].songName == 'Soul'){
			curDifficulty = 2;
	...
	function changeSelection(change:Int = 0)
	{
		...
		if (songs[curSelected].songName == 'Hallow' || songs[curSelected].songName == 'Hardships' || songs[curSelected].songName == 'Portrait' || songs[curSelected].songName == 'Prayer' || songs[curSelected].songName == 'Bad-Nun' || songs[curSelected].songName == 'Space-Demons' || songs[curSelected].songName == 'Soul'){
			curDifficulty = 2;
			changeDiff();
